...
@implementation KDEditImageView
...
-(id)initWithImageUrl:(NSString *)url size:(CGSize)size {
    ...
    if (self) {
        ...
        self.imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, size.width / 2, size.height / 2)];
